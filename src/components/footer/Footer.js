...
const Footer = () => {
  ...
  const scrollToTop = () => {
    document.getElementById('topOfPageRef').scrollIntoView({behavior: 'smooth'});
  };
      ...
      <div className="footer-content">
        <div className="footer-row-1">
          <div className="aloum-desc">
            <img className="aloum-footer-logo" src={aloumFooterLogo} onClick={() => scrollToTop()}/>
        ...
        <div className="footer-row-2">
          <div className="copyright">
            <span style={{ color: "#707070" }}>&copy; </span>AloumDaum {year}.
          </div>
